        ...
        <table className="w-full text-left border-collapse table-fixed">
          <thead>
            <tr className="bg-muted/50 text-muted-foreground border-b border-border">
              <th className="px-4 py-3 font-medium w-20 max-[768px]:w-16">类型</th>
              <th className="px-4 py-3 font-medium">名称</th>
              <th className="px-4 py-3 font-medium">开始时间</th>
              <th className="px-4 py-3 font-medium text-right max-[768px]:hidden">距离</th>
              <th className="px-4 py-3 font-medium text-right max-[768px]:hidden">运动时间</th>
              <th className="px-4 py-3 font-medium text-right max-[768px]:hidden">总时间</th>
              <th className="px-4 py-3 font-medium text-right max-[768px]:hidden">平均心率</th>
              <th className="px-4 py-3 font-medium text-right max-[768px]:hidden">爬升</th>
            </tr>
          </thead>
