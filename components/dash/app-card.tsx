...
import { IconCircleCheckFilled, IconDeviceWatch } from "@tabler/icons-react"
      ...
      <div className="flex items-center gap-6 p-6">
        ...
        <div className="flex-1">
          <div className="flex items-center gap-3 mb-2">
            ...
            <Badge
              variant="secondary"
              className="bg-emerald-50 text-emerald-700 dark:bg-emerald-950/30 dark:text-emerald-400 gap-1 border-emerald-200"
            >
            ...
            {app.updated_at && (
              <div className="flex items-center gap-2 text-sm">
                ...
                <span className="font-medium font-mono">
                  {dayjs(app.updated_at).format("YYYY-MM-DD HH:mm")}
                </span>
              </div>
            )}
            {app.last_synced_at && (
              <div className="flex items-center gap-2 text-sm">
                ...
                <span className="font-medium font-mono">
                  {dayjs(app.last_synced_at).format("YYYY-MM-DD HH:mm")}
                </span>
              </div>
            )}
          </div>
